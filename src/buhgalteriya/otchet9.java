...
public class otchet9 extends javax.swing.JFrame {
    public otchet9() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(718, 241));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Statement stmt = null;
            String query ="SELECT sum1 AS 'Доходи' FROM(SELECT SUM(summa) AS sum1 FROM dokhody WHERE schet='"+rah+"') AS a, dokhody WHERE Year(Date)='"+rik+"' AND Day(Date)>=01 AND Day(Date)<=31 AND Month(Date)='"+Number+"' GROUP BY sum1";
